...
"I think an computer program is many instruction given to an computer to peform a certain task"
# 2. Name three (3) data types
"Text,Mapping,Numbers"
# 3. Name three (3) python Operators
"Three python operators are arithematic,assignment and comparison."
# 4. In your own words, what is a variable?
"A container for data/information"
# READING PROMPTS
...
"I would use comparison because the text is deteermining who has what"
...
# Which python operator would you use in this situation? Explain why.
"I would arithmatic to calculate the prices and assignment to assign the prices to the cart"
...
# Which python operator would you use in this situation? Explain why
 "comparison operator because we want to see if they are the same/compare