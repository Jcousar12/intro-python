...
' A function parameter is the variable listed inside the parenthesis in the function defintion'
'An argument is the value that is sent to the function when its called'
...
# type error
# name error
'synax error is the formatting rules of language'
'type error is when data types does not match and type error can come up'
'name error Variables name are not short and descriptive.'
'Variables names does not start with letters'
...
'this is an built in function for converting data'

# 4. What function would I use if I wanted to change a float data type into a 
# an integer data type?
'I would use a type function if I wanted to change a float data type into an integer data type'

# 5. Describe three (3) Variable naming rules. Write your response in complete sentences. 
'Variables name are short and descriptive.'
'Variables names can start with a letters'
'or an underscore (_)'
...
'comparison operator is the family of =!'
'comparison operator is the family of =='
'assignment operator is the family of ='
#symbols
# = 
# == 
# =! 
...
'arithmatic operator is being used because I see numbers'
...
'the assignmnet operator is being used in this problem because of =M'
